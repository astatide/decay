...
#[derive(Debug)]
pub struct Atom<EleT, NumT, VecT: IntoIterator<Item=NumT>> {
    pub element: EleT,
    pub id: String,
...
impl<EleT, NumT, VecT: IntoIterator<Item=NumT>> IsAtomic<EleT, NumT, VecT> for Atom<EleT, NumT, VecT> {}

impl<EleT, NumT, VecT: IntoIterator<Item=NumT>> HasElement<EleT> for Atom<EleT, NumT, VecT> {
    fn get_element(&self) -> &EleT {
        return &self.element;
    }
}

impl<EleT, NumT, VecT: IntoIterator<Item=NumT>> Connected<Vec<String>> for Atom<EleT, NumT, VecT> {
    fn force(&self) {}
...
impl<EleT, NumT, VecT: IntoIterator<Item=NumT>> HasCharge<NumT> for Atom<EleT, NumT, VecT> {
    fn force(&self) {
        todo!()
    }
...
impl<EleT, NumT, VecT: IntoIterator<Item=NumT>> HasPhysics<VecT> for Atom<EleT, NumT, VecT> {
